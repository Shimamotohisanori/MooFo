...
namespace nsK2Engine {
    ...
    {
        // 太陽光
        m_light.directionalLight[0].color.x = 4.8f;
        m_light.directionalLight[0].color.y = 4.8f;
        m_light.directionalLight[0].color.z = 5.0f;
      ...
      /*  m_light.directionalLight[1].color.x = 1.0f;
        ...
        m_light.ambinetLight.x = 5.0f;
        m_light.ambinetLight.y = 5.0f;
        m_light.ambinetLight.z = 5.0f;
